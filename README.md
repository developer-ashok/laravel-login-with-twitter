...
laravel login with facebook easy integration
...
1. clone package [git clone https://github.com/developer-ashok/laravel-login-with-facebook]
2. install composer dependency [composer install]
3. php artisan serve

<a href="https://codescompanion.com/easy-integration-of-facebook-login-with-laravel-5-x">Read more..</a>.
